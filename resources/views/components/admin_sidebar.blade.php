            ...
            <nav>
                <ul class="metismenu" id="menu">
                    <li class="{{ url()->current() == route('adminDashboard') ? 'active' : '' }}">
                        <a href="{{ route('adminDashboard') }}" aria-expanded="true"><i
                                class="ti-dashboard"></i><span>Dashboard</span></a>
                    </li>
                    <li>
                        <a href="{{ route('adminBuku') }}" aria-expanded="true"><i
                                class="ti-layout-sidebar-left"></i><span>Buku
                            </span></a>
                        <ul>
                            <li class="{{ url()->current() == route('adminBuku') ? 'active' : '' }}">
                                <a href="{{ route('adminBuku') }}">List Buku</a>
                            </li>
                            <li class="{{ url()->current() == route('adminBukuCreate') ? 'active' : '' }}">
                                <a href="{{ route('adminBukuCreate') }}">Add Buku</a>
                            </li>
                        </ul>
                    </li>
                    <li>
