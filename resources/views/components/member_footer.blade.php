    ...
    <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2 mt-2">
                            <a href="#"
                                class="w-7 h-7 rounded-md bg-gray-800 hover:bg-indigo-600 flex items-center justify-center transition-colors">
                                <svg class="w-3.5 h-3.5 text-gray-400 hover:text-white" viewBox="0 0 24 24"
                                    fill="currentColor">
                                    <path
                            ...
                            <a href="#"
                                class="w-7 h-7 rounded-md bg-gray-800 hover:bg-indi
                            go-600 flex items-center justify-center transition-colors">
                                <svg class="w-3.5 h-3.5 text-gray-400 hover:text-white" viewBox="0 0 24 24"
                                    fill="currentColor">
                                    <path
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-x-6 gap-y-1.5">
                        <a href="{{ route('dashboard') }}"
                            class="text-gray-400 hover:text-indigo-400 transition-colors text-xs">Home</a>
                        <a href="{{ route('allBuku') }}"
                            class="text-gray-400 hover:text-indigo-400 transition-colors text-xs">Semua Buku</a>
                        <a href="{{ route('allCategories') }}"
                            class="text-gray-400 hover:text-indigo-400 transition-colors text-xs">Kategori</a>
                        @if (Auth::check() && Auth::user()->role == 'member')
                            <a href="{{ route('pinjam') }}"
                                class="text-gray-400 hover:text-indigo-400 transition-colors text-xs">Peminjaman
                                Saya</a>
                        @endif
                    </div>
                </div>
            ...
            <div class="mt-6 pt-4 border-t border-gray-800 text-center">
                <p class="text-xs text-gray-500">&copy; 2025 Perpustakaan Daerah Provinsi Papua. Hak cipta dilindungi.
                </p>
            </div>
        </div>
    </div>
