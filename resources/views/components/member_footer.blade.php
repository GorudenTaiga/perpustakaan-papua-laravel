        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-4">
                    ...
                    <p class="text-gray-400 text-sm mb-6">Perpustakaan digital terlengkap untuk masyarakat Papua. Akses
                        ribuan buku kapan saja, di mana saja.</p>

                    <div class="flex gap-3">
                        <a href="#"
                            class="w-10 h-10 rounded-lg bg-gray-800 hover:bg-indigo-600 flex items-center justify-center transition-colors group">
                ...
                <div class="lg:col-span-3">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="{{ route('allBuku') }}"
                                class="text-gray-400 hover:text-indigo-400 transition-colors text-sm">Semua Buku</a>
                        </li>
                        <li><a href="{{ route('allCategories') }}"
                                class="text-gray-400 hover:text-indigo-400 transition-colors text-sm">Kategori</a></li>
                        @if (Auth::check() && Auth::user()->role == 'member')
                            <li><a href="{{ route('pinjam') }}"
                                    class="text-gray-400 hover:text-indigo-400 transition-colors text-sm">Peminjaman
                                    Saya</a></li>
                        @endif
                    </ul>
                </div>
