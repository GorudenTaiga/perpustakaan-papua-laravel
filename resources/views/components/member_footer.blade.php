<section class="py-5">
    <div class="container-fluid">
        <div class="row row-cols-1 row-cols-sm-3 row-cols-lg-5 d-flex justify-content-between">
            <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card-body p-0">
                                <h5>Gratis Peminjaman</h5>
                                <p class="card-text">Nikmati meminjam buku dengan puas secara gratis.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card mb-3 border-0">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card-body p-0">
                                <h5>100% Keaslian Buku</h5>
                                <p class="card-text">Buku yang ditampilkan adalah 100% berasal dari pusat perpustakaan.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card-body p-0">
                                ...
                                <p class="card-text">Buku yang tersedia sudah memiliki kualitas yang terjamin.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer-menu">
                    <img src="{{ asset('logo.png') }}" style="max-height: 128px" alt="logo">
