...
<body>
        ...
        <div class="container-fluid">
            <div class="row py-3 border-bottom">
                ...
                <div class="col-sm-4 col-lg-3 text-center text-sm-start">
                    <div class="main-logo">
                        <img src="{{ asset('logo.png') }}" style="max-height: 120px" alt="logo"
                            class="img-fluid">
                        <h4>
                ...
                <div
                    class="col-sm-6 offset-sm-2 text-center align-items-center offset-md-0 col-lg-5 d-none d-lg-block">
                    <nav class="d-flex navbar navbar-expand-lg">
                        <div class="offcanvas offcanvas-end" style="justify-content: between" id="offcanvasNavbar"
                            ...
                            <div class="offcanvas-body">
                                <ul
                                    ...
                                    <li class="nav-item dropdown">
                                        <a href="{{ route('allBuku') }}" class="nav-link">Buku</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('allCategories') }}" class="nav-link">Kategori</a>
                                    </li>
                ...
                <div
                    ...
                    <div class="support-box text-end d-none d-xl-block">
                        ...
                        <h5 class="mb-0">+62 87743160171</h5>
                    </div>
    ...
    <script src="/users/js/jquery-1.11.0.min.js"></script>
