...
<body class="min-h-screen bg-white">
    ...
    <!-- Loading Animation -->
    <div id="preloader" class="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600">
        <div class="relative">
    ...
    <div x-data="{ open: false }" @keydown.escape.window="open = false">
        ...
        <div x-show="open"
             ...
             class="fixed right-0 top-0 z-50 h-full w-full sm:w-96 glass shadow-2xl"
             style="display: none;">
                    ...
                    <form role="search" action="{{ route('allBuku') }}" method="get" class="space-y-4">
                        <div class="relative">
                            <input 
                                ...
                                name="search"
                                autocomplete="off">
                            <button class="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 p-2 text-white hover:from-indigo-700 hover:to-purple-700 transition-all" type="submit">
    ...
    <div x-data="{ wishlistOpen: false }" @keydown.escape.window="wishlistOpen = false">
        ...
        <div x-show="wishlistOpen"
             ...
             style="display: none;">
            <div class="flex h-full flex-col">
                <div class="flex items-center justify-between border-b border-gray-200/50 bg-gradient-to-r from-pink-500 to-rose-500 p-6">
                    ...
                    <button @click="wishlistOpen = false" class="rounded-lg p-2 hover:bg-white/20 transition-colors">
                ...
                <div class="flex-1 overflow-y-auto p-6">
                    @if (Auth::check())
                        ...
                        @else
                            <div class="flex flex-col items-center justify-center h-full text-center py-12">
                                ...
                                <p class="text-sm text-gray-500 mb-4">Start adding books you love to your wishlist!</p>
                                <a href="{{ route('allBuku') }}" class="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-pink-500 to-rose-500 px-4 py-2 text-sm font-medium text-white hover:from-pink-600 hover:to-rose-600 transition-all">
                                    Browse Books
                                </a>
                            </div>
                        @endif
                    @else
                        <div class="flex flex-col items-center justify-center h-full text-center py-12">
                            ...
                            <a href="{{ route('login') }}" class="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-2 text-sm font-medium text-white hover:from-indigo-700 hover:to-purple-700 transition-all">
                                Login Now
                            </a>
                        </div>
                    @endif
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex items-center justify-between py-4">
                ...
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 group">
                    <div class="relative">
                        <img src="{{ asset('logo.png') }}" alt="logo" class="h-14 w-14 object-contain transition-transform group-hover:scale-110">
                        <div class="absolute inset-0 bg-gradient-to-br from-indigo-600/20 to-purple-600/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div class="hidden xl:flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-100">
                    ...
                    @if (Auth::user())
                        ...
                        <button @click="wishlistOpen = true" 
                            ...
                            @if(isset($wishlist) && count($wishlist) > 0)
                                <span class="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-br from-pink-500 to-rose-500 text-white text-xs font-bold rounded-full flex items-center justify-center animate-pulse">
                                    {{ count($wishlist) }}
                                </span>
                            @endif
                        </button>
                        ...
                        <a href="{{ Auth::user()->role == 'member' ? route('userProfile') : route('filament.admin.pages.dashboard') }}" 
                           class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gradient-to-br hover:from-indigo-50 hover:to-purple-50 transition-all group">
                            <div class="w-9 h-9 rounded-full bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center text-white font-bold text-sm shadow-lg">
                                {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                            </div>
                            <span class="hidden md:block text-sm font-medium text-gray-700 group-hover:text-indigo-600 transition-colors">
        ...
        <div x-data="{ mobileMenuOpen: false }" 
            ...
            <div class="container mx-auto px-4 py-4 space-y-2">
                ...
                <div class="pt-3 border-t border-gray-200">
                    <div class="flex items-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-indigo-50 to-purple-50">
                        <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <div>
