        ...
        <div class="container mx-auto px-4" x-data="{ showFilters: false }">
            ...
            <div class="lg:hidden mb-4">
                <button @click="showFilters = !showFilters"
                    ...
                    <span x-text="showFilters ? 'Sembunyikan Filter & Cari' : 'Tampilkan Filter & Cari'">Tampilkan Filter &
                        Cari</span>
                </button>
            </div>
            ...
            <div class="grid lg:grid-cols-4 gap-4 lg:gap-8">
                ...
                <aside class="lg:col-span-1" :class="showFilters ? 'block' : 'hidden lg:block'">
                    <div
                        class="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 sm:p-6 sticky top-24 space-y-4 sm:space-y-6">
                        {{-- Search Bar --}}
                        <div>
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-4">
                            ...
                            <form action="{{ route('allBuku') }}" method="GET" class="w-full sm:w-auto">
                                <select name="sortBy" onchange="this.form.submit()"
                                    ...
                                    <option value="ratingDesc" {{ request('sortBy') == 'ratingDesc' ? 'selected' : '' }}>
                                        Rating Tertinggi</option>
                                    <option value="ratingAsc" {{ request('sortBy') == 'ratingAsc' ? 'selected' : '' }}>
                                        Rating Terendah</option>
                                </select>
                            </form>
                        </div>
                    </div>
                                            ...
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center gap-1">
                                                    @if ($b->average_rating > 0)
                                                        <div class="flex items-center gap-1">
                                                            <svg class="w-3 h-3 sm:w-4 sm:h-4 text-yellow-400"
                                                ...
                                                <svg class="sm:hidden w-4 h-4 text-gray-400 group-hover:text-indigo-600 transition-colors"
                                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M9 5l7 7-7 7"></path>
                                                </svg>
