        ...
        <div class="container relative mx-auto px-4">
            <div class="text-white space-y-3 sm:space-y-6">
                <div
                    ...
                    <span class="text-xs sm:text-sm font-semibold">Jelajahi Kategori</span>
                </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
                @forelse ($categories as $c)
                    <a href="{{ route('allBuku', ['category[]' => $c->id]) }}"
                        class="group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-indigo-200 block">
                        <div class="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 aspect-[4/3]">
                            ...
                            <div
                                class="absolute bottom-0 left-0 right-0 p-2 sm:p-4 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
