                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div class="relative hidden lg:block">
                                <div class="relative z-10 transform hover:scale-105 transition-transform duration-500">
                                    <img src="{{ asset('images/buku_dashboard.png') }}" alt="Buku" fetchpriority="high"
                    ...
                    <div class="swiper-slide">
                        <div class="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div class="relative hidden lg:block">
                                <div class="relative z-10 transform hover:scale-105 transition-transform duration-500">
                                    <img src="{{ asset('images/buku_dashboard.png') }}" alt="Buku Baru" loading="lazy"
                                        decoding="async" width="600" height="400"
                                        class="w-full h-auto drop-shadow-2xl">
                                </div>
                            </div>
                                        ...
                                        <div
                                            ...
                                            @if ($c->image)
                                                <img src="{{ asset($c->image) }}" alt="{{ $c->nama }}"
                                                    loading="lazy" decoding="async" width="200" height="250"
        ...
        <section class="py-20 bg-gradient-to-b from-gray-50 to-white">
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between mb-12">
                    <div>
                        <div
                            class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-50 border border-red-100 mb-4">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                    @foreach ($popularBooks as $index => $b)
                        <div class="group relative">
                            @if ($index < 3)
                                <div
                                    class="absolute -top-2 -left-2 z-20 w-10 h-10 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 flex items-center justify-center text-white font-bold text-sm shadow-lg">
                                    #{{ $index + 1 }}
                                </div>
                            @endif
                            <a href="{{ route('buku', $b->slug) }}"
        ...
        <section class="py-20 bg-white">
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between mb-12">
                    <div>
                        <div
                            class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 border border-green-100 mb-4">
                    ...
                    @foreach ($newArrivals as $b)
                        <div class="group relative">
                            <div class="absolute top-3 left-3 z-10">
                                <span
                                    class="px-3 py-1 bg-green-500 text-white text-xs font-bold rounded-full shadow-lg">BARU</span>
                            </div>
                            <a href="{{ route('buku', $b->slug) }}"
                                class="block relative overflow-hidden rounded-2xl bg-white shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3">
                                <div class="aspect-[3/4] overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
