...
<body>
    ...
    <div>
        ...
        <div class="summary-box"><strong>Aktif:</strong>
            {{ $pinjaman->whereIn('status', ['dipinjam', 'menunggu_verif'])->count() }}</div>
        <div class="summary-box"><strong>Dikembalikan:</strong> {{ $pinjaman->where('status', 'dikembalikan')->count() }}
        </div>
    </div>
