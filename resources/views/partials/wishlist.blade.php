                ...
                <div
                    ...
                    <div class="flex gap-4">
                        <div class="relative w-16 h-24 flex-shrink-0 overflow-hidden rounded-lg">
                            <img src="{{ $item->buku->bannerUrl ?: asset('images/media_placeholder.webp') }}"
                                alt="{{ $item->buku->judul }}"
                                class="h-full w-full object-cover group-hover:scale-110 transition-transform duration-300">
                        </div>
                        <div class="flex-1 min-w-0">
                            <h4 class="font-semibold text-gray-900 text-sm line-clamp-2 mb-2">{{ $item->buku->judul }}
                            </h4>
                        ...
                        <button onclick="removeWishlist({{ $item->buku->id }}, this)"
                            class="flex-shrink-0 p-1.5 rounded-lg text-gray-400 hover:text-red-500 hover:bg-red-50 transition-all"
                            title="Remove">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
